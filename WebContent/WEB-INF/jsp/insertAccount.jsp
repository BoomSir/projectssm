...
<head>
	...
	<body>
		...
		<form id="userForm" name="userForm" action="insertAccount.action" method="post"> 
		<div class="main">
			<div class="global-width">
				...
				<div class="action">
						...
						<div class="pages">
							<table width="90%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr >
									<td align="right" width="30%">昵称：</td><td  align="left"><input type="text" name="vname"  id="vname"/></td>
								</tr>
								<tr >
									<td align="right" width="30%">年龄：</td><td  align="left"><input type="text" name="age"   id="age"/></td>
								</tr>
								<tr >
									<td align="right" width="30%">性别：</td><td  align="left"><input type="text" name="sex"  id="sex"/></td>
								</tr>
								<tr >
								...
								<tr >
									<td align="center" colspan="2"><br/><input type="button"  id="save" value="保存数据" onclick="setit()" />
									<input type="button"  id="backindex" value="返回" onclick="location.href='${pageContext.request.contextPath}/user/backa.action'" /></td>
								</tr>
								</table>
						</div>
					</div>
	...
	<script type="text/javascript">
	 $(function(){
		$("#userForm").validate({
			...
			message : {
				username:"用户名不为空",
				password:{required:"请输入密码",minlength:"密码过短"}
			}
		});
	}) 
</script>
