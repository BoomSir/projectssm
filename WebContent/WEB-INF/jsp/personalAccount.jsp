...
<head>
	...
	<body>
		...
		<form id="myForm" name="myForm" action="editPerson.action" method="post">
				...
				<div class="action">
						...
						<div class="pages">
							<table width="90%" border="0" cellspacing="0" cellpadding="0">
								<tr >
									<td align="right" width="30%">用户名：</td><td  align="left"><input type="text" name="vname" value="${sessionUser.vname}" readonly="readonly" id="vname"/></td>
								</tr>
								<tr >
									<td align="right" width="30%">密码：</td><td  align="left"><input type="text" name="password" value="${sessionUser.password}" readonly="readonly" id="password"/></td>
								</tr>
								<tr >
									<td align="center" colspan="2"><br/><input type="button"  value="编辑数据" onclick="setit()" /></td>
								</tr>
