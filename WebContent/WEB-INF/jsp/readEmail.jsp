				...
				<div class="action">
						...
						<div class="pages">
							<table width="90%" border="0" cellspacing="0" cellpadding="0">
								<tr >
									<td align="right" width="30%">邮件标题：</td><td align="left"><input type="text" name="title" id="title" value="${oneMail.title}" readonly="readonly" /></td>
								</tr>
								<tr >
									<td align="right" width="30%">邮件内容：</td><td align="left">
										<textarea rows="10" cols="30" name="content" readonly="readonly">${oneMail.content}</textarea>
									</td>
								</tr>
								<tr >
									<td align="right" width="30%">发送时间：</td><td align="left"><input type="text" name="time" id="time" value="${oneMail.time}" readonly="readonly" /></td>
								</tr>
								<tr >
									<td align="right" width="30%">来自：</td><td align="left"><input type="text" name="fromwho" id="fromwho" value="${oneMail.operating}" readonly="readonly" /></td>
								</tr>
								<tr >
									<td align="right" width="30%">文件：</td><td align="left"><a href="${pageContext.request.contextPath}/user/loadDown.action">下载</a></td>
								</tr>
								<tr >
									<td><input type="button"  id="backindex" value="返回主页" onclick="location.href='${pageContext.request.contextPath}/user/recieveEmail'" /></td>
								</tr>
								</table>
						</div>
					</div>
